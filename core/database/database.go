...
func RequiredIndexes() []IndexSpec {
	...
	return []IndexSpec{
		...
		{models.CollectionObservations, mongo.IndexModel{Keys: bson.D{{Key: "organization_id", Value: 1}, {Key: "decision_state", Value: 1}, {Key: "decision_lease_expires_at", Value: 1}}, Options: named("decision_claim")}},
