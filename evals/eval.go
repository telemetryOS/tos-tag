...
func Fixtures() []Fixture {
	...
	bot := base("Build 1842 completed successfully")
	...
	return []Fixture{
		...
		{Name: "integration_message_suppressed", Target: bot, Pack: pack(), WantPredicted: types.OutcomeSilent, WantEffective: types.OutcomeSilent, SkipLiveProviderCall: true},
